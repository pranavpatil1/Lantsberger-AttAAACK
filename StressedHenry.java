...
{
    private static Weapon ball = new Weapon(7, 0, 0, 15, 15, new Image("stressball.png"));
    private static Weapon w2 = new Weapon(10, 0, 0, 15, 15, new Image("stressball.png"));
    private static Weapon w3 = new Weapon(13, 0, 0, 15, 15, new Image("stressball.png"));
    ...
    {
        super(x, y, 30, 70, new Image("henry.png"), 1, ball, w2, w3);
    }
    /**
